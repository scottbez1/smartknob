...
💡 **There is an ongoing search for new motors in [#16][issue16]** - follow along there for the latest info (or join in and help us find a good replacement). Any change in motor will likely require substantial redesigns, so *don't order PCBs/printed parts until there is more clarity on the motor.*

[issue16]: https://github.com/scottbez1/smartknob/issues/16
