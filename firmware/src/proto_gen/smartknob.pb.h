...
#define PB_SmartKnobState_init_default           {0}
#define PB_ToSmartknob_init_default              {0, 0, {PB_RequestState_init_default}}
#define PB_SmartKnobConfig_init_default          {0}
...
#define PB_SmartKnobState_init_zero              {0}
#define PB_ToSmartknob_init_zero                 {0, 0, {PB_RequestState_init_zero}}
#define PB_SmartKnobConfig_init_zero             {0}
...
#define PB_SmartKnobConfig_size                  0
#define PB_SmartKnobState_size                   0
#define PB_ToSmartknob_size                      8
